    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['device:mqttAcl:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['device:mqttAcl:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['device:mqttAcl:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listMqttAcl, getMqttAcl, delMqttAcl, addMqttAcl, updateMqttAcl } from "@/api/device/mqttAcl";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('device/mqttAcl/export', {
        ...this.queryParams
