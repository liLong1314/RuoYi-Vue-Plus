...
@RestController
@RequestMapping("/devices/mqttUser")
public class MqttUserController extends BaseController {
     ...
     */
    @SaCheckPermission("devices:mqttUser:list")
    @GetMapping("/list")
     ...
     */
    @SaCheckPermission("devices:mqttUser:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("devices:mqttUser:query")
    @GetMapping("/{id}")
     ...
     */
    @SaCheckPermission("devices:mqttUser:add")
     ...
     */
    @SaCheckPermission("devices:mqttUser:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("devices:mqttUser:remove")
